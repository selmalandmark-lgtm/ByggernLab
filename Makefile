...
SOURCE_FILES := main.c uart.c uart.h xmem.c xmem.h sram.c sram.h address_decoder.c address_decoder.h adc.h adc.c spi.c spi.h user_io_board.h user_io_board.c oled.c oled.h fonts.h fonts.c
